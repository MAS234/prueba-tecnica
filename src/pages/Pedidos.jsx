  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between px-5 items-center sm:px-10 md:px-20">
        ...
        <div className="w-full lg:w-96 flex justify-center sm:justify-start items-center gap-5 mt-3 sm:mt-0 " data-aos="fade-left">
          <div
            className="cursor-pointer bg-[#48D390] p-2 rounded-md hover:bg-[#208554] duration-200 w-full  sm:text-left  lg:mb-0"
            onClick={openModal}
          >
            <p className="text-white font-semibold text-sm sm:text-xl lg:text-base  text-center">
              AGREGAR PEDIDO
            </p>
          </div>
          <Link
            to={"/"}
            className="bg-[#48D390] p-2 rounded-md hover:bg-red-500 duration-200 w-full text-center sm:text-left"
          >
            <p className="text-white font-semibold text-sm sm:text-xl lg:text-base uppercase text-center">
              cerrar sesión
            </p>
          </Link>
        </div>
